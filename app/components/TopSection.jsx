  ...
  return (
    <section className="relative bg-[#f2f2f2] overflow-visible">
      <div className="container mx-auto px-0 max-w-full">
        <div className="flex w-full" style={{ fontFamily: 'Montserrat, sans-serif' }}>

          <div className="flex flex-col justify-between px-6 flex-1">
            <header className="flex justify-between items-center relative z-20 pb-20 ml-10 pt-5">
            ...
            <div className="max-w-xl ml-10">
              ...
              <div className="bg-white py-5 px-6 mb-20 rounded-lg">
                <SearchBar />
              </div>
            </div>
          </div>
          ...
          <div className="relative w-[603px] bg-[#00cc99] rounded-bl-[80px] px-8 pt-6 overflow-hidden">

            <div className="flex justify-end space-x-6 mb-10">
              <button className="text-white">Sign In</button>
              <button className="px-4 py-2 bg-white rounded-md text-black flex items-center gap-2">
